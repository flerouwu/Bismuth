...
public class ConfigManager {
    ...
    public void saveConfig(Class<?> clazz) throws ConfigException {
        ...
        try (FileWriter writer = new FileWriter(file)) {
            ...
            writer.write("# --------------------------\n");
            writer.write("# ATTENTION! DO NOT EDIT THIS FILE WHILE\n");
            writer.write("# MINECRAFT IS RUNNING! YOUR CHANGES WILL\n");
            writer.write("# BE OVERWRITTEN WHEN YOU EXIT MINECRAFT!\n");
            writer.write("# \n");
            writer.write("# Instead, either edit the config in-game,\n");
            writer.write("# or close the game before continuing.\n");
            writer.write("# --------------------------\n");
